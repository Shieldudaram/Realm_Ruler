...
public final class CtfCarrierSlotLockSystem extends EntityEventSystem<EntityStore, SwitchActiveSlotEvent> {
    ...
    public CtfCarrierSlotLockSystem(CtfMatchService matchService, CtfFlagStateService flagStateService) {
    ...
    public void handle(int entityId,
        ...
        if ((byte) (lockedSlot & 0xFF) == event.getNewSlot()) return;

        event.setNewSlot((byte) (lockedSlot & 0xFF));
